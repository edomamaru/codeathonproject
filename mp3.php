...
foreach ($files as $filename) {
    ...
    // Check if comment tag of file is null, if true, add module to json object
    if (! isset($fileInfo['tags']['id3v2']['comment'][0])) {
        ...
        // Set comment tag to 'Done'
        $data = array("comment" => 'Done');
        
        // id3_set_tag($filename, $data, id3_get_version($filename));
        $fileInfo['tags']['id3v2']['comment'] = 'Done';
    }
